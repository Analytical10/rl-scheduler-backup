...
class LoRa_pretrain_Model(torch.nn.Module):
    def __init__(
        self,
        model,
        *,
        ...
        for module_name, module in self.wrapped_model.named_modules():
            ...
            new_module = LoRa_pretrain_Linear(
                module.in_features,
                module.out_features,
                r=self.r,
...
class LoRa_pretrain_Linear(nn.Module):
    def __init__(
        self,
        in_features: int,
        out_features: int,
        ...
        *,
        ...
        nn.init.kaiming_uniform_(self.W0.weight, a=math.sqrt(5))
        # nn.init.zeros_(self.W0.weight)
