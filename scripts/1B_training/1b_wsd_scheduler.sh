...
# 登录 WandB
python -m swanlab login -k QFiQUODzekALv3OgIeyf7

# 设置环境变量
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export SWANLAB_PROJECT="rl_scheduler_galore"
export SWANLAB_RUN_NAME="Llama-1B-pt-wsd-scheduler"

# ================= 配置区域 =================
MODEL_CONFIG="configs/llama_1b.json"
DATASET_PATH="/mnt/bn/qiaoyongqi/pretrain/c4_origin"
WORKERS=8
...
RL_AGENT_LR=3e-4
RL_HISTORY_LEN=5
RL_SAVE_BASE_DIR="/mnt/bn/qiaoyongqi/model/llama/Llama-1B/scheduler_galore"
RUN_NAME_BASE="round_0_"
MODE='train'
ROUND=0
RL_BASE_SCHEDULER="wsd"
...
")
    ...
    while true; do
        ...
        torchrun --standalone --nproc_per_node=8 torchrun_main_DDP.py \
            ...
            --swanlab_project_name $SWANLAB_PROJECT \
