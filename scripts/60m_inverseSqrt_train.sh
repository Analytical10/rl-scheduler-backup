...
export WANDB_PROJECT="60M_Llama_InverseSqrt_Standard" 
...
LR=0.003              # 峰值学习率
WARMUP_STEPS=1100     # Inverse_Sqrt 建议 Warmup 稍微长一点
MAX_STEPS=11000      # 逆平方根通常用于长时训练，步数可以设大一点
WEIGHT_DECAY=0.1
DTYPE="bfloat16"
...
# 路径设置
RUN_NAME="60M_AdamW_InvSqrt_Run1"
