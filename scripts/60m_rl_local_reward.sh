...
export WANDB_PROJECT=${WANDB_PROJECT:-60M_model_local_reward_test_v3}
...
RL_HISTORY_LEN=5
RL_STATS_WINDOW=20
RL_SAVE_BASE_DIR="checkpoints/rl_agents_meta_run_v3"
RUN_NAME_BASE="60M_RL_local_reward_test_v3"
MODE='train'
ROUND=0
